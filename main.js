...
// GET THE CONDITIONS
weatherConditions.open('GET', '//api.openweathermap.org/data/2.5/weather?zip=84653,us&appid=39031dfa8df4985950e16756955313a3&units=imperial', true);
...
weatherConditions.onload = function() {
    if (weatherConditions.status === 200){
        ...
        document.getElementById('temerature').innerHTML=cObj.main.temp;
...
// GET THE FORECARST
weatherForecast.open('GET', '//api.openweathermap.org/data/2.5/forecast?zip=84653,us&appid=39031dfa8df4985950e16756955313a3&units=imperial', true);
